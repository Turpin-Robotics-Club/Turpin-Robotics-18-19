...
@TeleOp(name = "One Drive", group = "Teleop Finals")
public class OneDrive extends OpMode {
    ...
    private void DriveOperator(){
        ...
        if(gamepad1.left_bumper) push.setPower(-0.75);
        else if(gamepad1.left_trigger>0.5) push.setPower(0.75);
        ...
        if(gamepad1.a) slap.setPower(0.9);
        else if(gamepad1.b) slap.setPower(-0.4);
